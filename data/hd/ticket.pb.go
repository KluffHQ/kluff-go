...
type TabTicket struct {
	...
	ResponseBy                    *timestamppb.Timestamp `protobuf:"bytes,18,opt,name=response_by,json=responseBy,proto3" json:"response_by,omitempty"`
	...
	ResolutionBy                  *timestamppb.Timestamp `protobuf:"bytes,20,opt,name=resolution_by,json=resolutionBy,proto3" json:"resolution_by,omitempty"`
	ServiceLevelAgreementCreation *timestamppb.Timestamp `protobuf:"bytes,21,opt,name=service_level_agreement_creation,json=serviceLevelAgreementCreation,proto3" json:"service_level_agreement_creation,omitempty"`
	OnHoldSince                   *timestamppb.Timestamp `protobuf:"bytes,22,opt,name=on_hold_since,json=onHoldSince,proto3" json:"on_hold_since,omitempty"`
	...
	FirstRespondedOn              *timestamppb.Timestamp `protobuf:"bytes,25,opt,name=first_responded_on,json=firstRespondedOn,proto3" json:"first_responded_on,omitempty"`
	...
	OpeningDate                   *timestamppb.Timestamp `protobuf:"bytes,28,opt,name=opening_date,json=openingDate,proto3" json:"opening_date,omitempty"`
	OpeningTime                   *timestamppb.Timestamp `protobuf:"bytes,29,opt,name=opening_time,json=openingTime,proto3" json:"opening_time,omitempty"`
	ResolutionDate                *timestamppb.Timestamp `protobuf:"bytes,30,opt,name=resolution_date,json=resolutionDate,proto3" json:"resolution_date,omitempty"`
...
func (x *TabTicket) GetCreation() *timestamppb.Timestamp {
	if x != nil {
		return x.Creation
	}
	return nil
...
func (x *TabTicket) GetModified() *timestamppb.Timestamp {
	if x != nil {
		return x.Modified
	}
	return nil
...
func (x *TabTicket) GetResponseBy() *timestamppb.Timestamp {
	if x != nil {
		return x.ResponseBy
	}
	return nil
...
func (x *TabTicket) GetResolutionBy() *timestamppb.Timestamp {
	if x != nil {
...
func (x *TabTicket) GetServiceLevelAgreementCreation() *timestamppb.Timestamp {
	if x != nil {
...
func (x *TabTicket) GetOnHoldSince() *timestamppb.Timestamp {
	if x != nil {
...
func (x *TabTicket) GetFirstRespondedOn() *timestamppb.Timestamp {
	if x != nil {
...
func (x *TabTicket) GetOpeningDate() *timestamppb.Timestamp {
	if x != nil {
...
func (x *TabTicket) GetOpeningTime() *timestamppb.Timestamp {
	if x != nil {
...
func (x *TabTicket) GetResolutionDate() *timestamppb.Timestamp {
	if x != nil {
