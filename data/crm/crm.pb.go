...
type Event struct {
	...
	StartsOn      *timestamp.Timestamp `protobuf:"bytes,4,opt,name=starts_on,json=startsOn,proto3" json:"starts_on,omitempty"`
	EndsOn        *timestamp.Timestamp `protobuf:"bytes,5,opt,name=ends_on,json=endsOn,proto3" json:"ends_on,omitempty"`
...
func (x *Event) GetStartsOn() *timestamp.Timestamp {
	if x != nil {
		return x.StartsOn
	}
	return nil
...
func (x *Event) GetEndsOn() *timestamp.Timestamp {
	if x != nil {
		return x.EndsOn
	}
	return nil
...
func (x *ToDo) GetDate() *timestamp.Timestamp {
	if x != nil {
		return x.Date
	}
	return nil
